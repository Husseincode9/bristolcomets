...
export default function SunRunPage() {
  ...
  return (
    <div className="space-y-6 px-6 min-h-[80vh]">
      <h1 className="text-2xl font-semibold">Sunday Open Run</h1>
      <p className="text-foreground/70">13:00–15:00 · The Park Centre, Knowle, Bristol · cap 25 · £5 non‑members</p>
